...
# ---------------------------------------------------------------------------- #
    ...
    :decision_tree => (
        ...
        features       = [maximum, minimum, mean, std],
        treatment      = (mode=SoleBase.wholewindow, params=(;)),
...
# ---------------------------------------------------------------------------- #
    ...
    :modal_decision_tree => (
        ...
        features = [mean],
        treatment = (mode=SoleBase.adaptivewindow, params=(nwindows=10, relative_overlap=0.3)),
...
# ---------------------------------------------------------------------------- #
    ...
    :modal_decision_list => (
        ...
        data_treatment = :aggregate,
        features = [maximum, minimum, mean], # magari catch9
        treatment = (mode=SoleBase.wholewindow, params=(;)),
