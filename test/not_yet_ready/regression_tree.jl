...
# references:
# https://forem.julialang.org/mlj/julia-boards-the-titanic-1ne8
# https://blog.devgenius.io/decision-trees-in-julia-6aae1e7b9f5b
# https://juliaai.github.io/MLJ.jl/v0.19/common_mlj_workflows/
...
ds = SoleXplorer.preprocess_dataset(X, "MEDV", model, features=features)
